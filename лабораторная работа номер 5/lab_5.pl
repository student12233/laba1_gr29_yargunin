...
pr_6:-N6=[[воронов,танцор],[павлов,певец],[левицкий,писатель],[сахаров,художник]],
    in_list(N6,[воронов,_]),
    in_list(N6,[павлов,_]),
    in_list(N6,[левицкий,_]),
    in_list(N6,[сахаров,_]),

    in_list(N6,[_,танцор]),
    in_list(N6,[_,художник]),
    in_list(N6,[_,певец]),
    in_list(N6,[_,писатель]),

    not(in_list(N6,[воронов,певец])),
    not(in_list(N6,[левицкий,певец])),
     not(in_list(N6,[павлов,писатель])),
      not(in_list(N6,[павлов,художник])),
      not(in_list(N6,[сахаров,писатель])),
      not(in_list(N6,[воронов,писатель])),
      not(in_list(N6,[левицкий,певец])),
    (    in_list(N6,[левицкий,писатель]),not(in_list(N6,[воронов,художник]));( not(in_list(N6,[левицкий,писатель])))),
 (   in_list(N6,[воронов,писатель]),not(in_list(N6,[левицкий,художник]));(not(in_list(N6,[воронов,писатель])))),
